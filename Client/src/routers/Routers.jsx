...
import IncidentManagement from "../pages/Settings/IncidentManagement";
      ...
      <BrowserRouter>
        {auth.token ? (
          <Layout className="min-h-screen">
            ...
            >
              <Routes>
                <Route path="/" element={<Navigate to="/bang-dieu-khien" />} />
                <Route path="/bang-dieu-khien" element={<Dashboard />} />
                <Route path="/cai-dat" element={<Settings t={t} />} />
                <Route
                ...
                <Route
                  ...
                  element={
                    <ProtectedRoute
                      element={<CabinetManagement t={t} />}
                      requiredRole={[1, 2]}
                    />
                  }
                />
                <Route
                  path="/cai-dat/quan-ly-su-co"
                  element={
                    <ProtectedRoute
                      element={<IncidentManagement t={t} />}
                      requiredRole={[1, 2, 3]}
                    />
                  }
                />
